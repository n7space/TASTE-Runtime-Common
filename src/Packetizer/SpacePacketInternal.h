...
#define SPACE_PACKET_APID_HIGH_BITS_MASK 0xE0u
...
#define CCSDS_SPACE_PACKET_TYPE_MASK 0x10
#define CCSDS_SPACE_PACKET_APID_HIGH_BITS_MASK 0x07
#define CCSDS_SPACE_PACKET_TYPE_OFFSET 4u
#define CCSDS_SPACE_PACKET_SECONDARY_HEADER_FLAG_OFFSET 3u
#define CCSDS_SPACE_PACKET_SEQUENCE_FLAGS_FIRST_OFFSET 7u
#define CCSDS_SPACE_PACKET_SEQUENCE_FLAGS_SECOND_OFFSET 6u
