...
#ifndef PASSTHROUGH_PACKETIZER_H
#define PASSTHROUGH_PACKETIZER_H
 ...
 * @returns Packet size.
 */
size_t PassthroughPacketizer_packetize(Packetizer* const self,
 ...
 */
bool PassthroughPacketizer_depacketize(const Packetizer* const self,
                                       const Packetizer_PacketType packetType,
...
#endif // PASSTHROUGH_PACKETIZER_H
